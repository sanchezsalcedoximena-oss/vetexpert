...
export default function RegistroPage() {
  ...
  async function enviarFormulario(event: FormEvent<HTMLFormElement>) {
    ...
    const validacion = registroSchema.safeParse(valores);
  ...
  return (
    <AuthShell titulo="Registro cliente" descripcion="Crea tu acceso para consultar tus mascotas y atenciones.">
      ...
      <p className="mt-4 text-sm text-texto/68">
        Ya tienes cuenta?{" "}
        <Link className="font-semibold text-primario hover:underline" href="/login">
          Inicia sesion
        </Link>
      </p>
    </AuthShell>
